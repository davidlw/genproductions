...
externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    args = cms.vstring('/cvmfs/cms-griddata.cern.ch/phys_generator/gridpacks_tarball/PbPb/5p36TeV/starlight/coherent_JpsiToEE/starlight_coherent_jpsi_dielectron_Rplus1fm_XnXn__HeavyIon_tarball.tgz'),
