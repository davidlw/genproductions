...
externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    args = cms.vstring('/cvmfs/cms-griddata.cern.ch/phys_generator/gridpacks_tarball/PbPb/5p36TeV/starlight/coherent_psi2SToEE/starlight_coherent_psi2s_dielectron_Rplus1fm__HeavyIon_tarball.tgz'),
