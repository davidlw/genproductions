...
externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    args = cms.vstring('/cvmfs/cms-griddata.cern.ch/phys_generator/gridpacks_tarball/PbPb/5p36TeV/starlight/incoherent_psi2SToEE/starlight_incoherent_psi2s_dielectron__HeavyIon_tarball.tgz'),
